...
import com.openfire.imchat.adapter.FriendsExpandableListAdapter;
import com.openfire.imchat.beans.CurrentUser;
import com.openfire.imchat.beans.FriendInfo;
import com.openfire.imchat.manager.ConnectionManager;
import com.openfire.imchat.manager.RosterManager;
import com.openfire.imchat.manager.SubscribeManager;
import com.openfire.imchat.window.ConfirmPopWindow;
...
public class FriendsActivity extends AppCompatActivity implements View.OnClickListener, RosterListener, ExpandableListView.OnChildClickListener {
    ...
    public boolean onChildClick(ExpandableListView parent, View view, int groupPosition, int childPosition, long id) {
        ...
        cfriend.getInstance().setCfriend(chattoJid);
        System.out.println("chattoJid"+chattoJid);
