package com.openfire.imchat.window;
...
import com.openfire.imchat.activity.FriendsAddActivity;
...
public class ConfirmPopWindow extends PopupWindow implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        //需改       intent = new Intent(context, ChatRoomOperateActivity.class);
        //需改        context.startActivity(intent);
                break;
            case R.id.ll_friend:
